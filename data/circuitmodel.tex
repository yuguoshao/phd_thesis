...
\begin{proposition}
    ...
    为了估计$\widetilde{\mathcal{L}}(\bm{\theta})$使得$\mathbb{E}_{\bm{\theta}}\abs{\widetilde{\mathcal{L}}-\widehat{\mathcal{L}}}^2$小于一个足够小的常数，有：
    \begin{enumerate}
