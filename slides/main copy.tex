...
\end{frame}
\note{In this talk, I will first introduce the background of quantum computing. 

And bring an overview(over-vu) of the history of quantum computing and the potential of quantum computers.
  
Next, I will discuss the variational quantum algorithms, which are designed for today's quantum devices and have the potential to achieve practical quantum advantages.
  
Then, I will introduce our recent work on the simulation of noisy variational quantum circuits. 

This work is to address the question that whether the quantum advantage of variational quantum algorithms can be maintained(main-tained) in the presence(\textipa{ˈprez(ə)ns}) of noise.
